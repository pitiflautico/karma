...
<div class="relative min-h-screen w-full overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col min-h-screen">
        <!-- Logo Section (Upper part) -->
        <div class="flex-1 flex items-center justify-center pt-16">
            <h1 class="text-6xl font-serif text-white tracking-wide drop-shadow-lg">
        ...
        <div class="relative">
            ...
            <div class="bg-white rounded-t-[6rem] pt-20 pb-12 px-6 shadow-2xl">
                ...
                <button
                    ...
                    class="flex items-center justify-center w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-medium py-4 px-6 rounded-full mb-6 transition-all duration-200 shadow-lg">
