            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                @foreach($selfies as $selfie)
                    <div class="relative group">
                        ...
                        <!-- Overlay with info -->
                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-200 rounded-lg flex items-end p-3">
                            <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 w-full">
                                ...
                                <button
                                    ...
                                    class="mt-2 w-full bg-red-500 hover:bg-red-600 text-white text-sm py-1 px-3 rounded transition-colors"
                                >
                                    Delete
                                </button>
                            </div>
